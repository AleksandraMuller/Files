...
<html lang="en"> <!-- language English -->
    <head>
        ...
        <meta name="description" content="Omnifood is a premium food delivery service with the mission to bring affordable and healthy meals.">
        ...
        <link rel="mask-icon" href="/resources/favicons/safari-pinned-tab.svg" color="#322a2a">
    ...
    <body>
        <header>
            <nav>
                <div class="row">
                    ...
                    <a class="mobile-nav-icon js--nav-icon"><ion-icon name="menu" class="icon-navicon-round js--navicon"></ion-icon></a>
                </div>
            </nav>
        ...
        <section class="section-features js--section-features" id="features">
            ...
            <div class="row js--wp-1">
                ...
                <div class="col span-1-of-4 box">
                    <ion-icon name="leaf" class="icon-big"></ion-icon>
                    <h3>100% organic</h3>
            ...
            <div class="row">
                ...
                <div class="col span-1-of-2">
                    <ul class="social-links">
                        <li><a href="#"><ion-icon name="logo-facebook" class="ion-social-facebook"></ion-icon></a></li>
                        <li><a href="#"><ion-icon name="logo-twitter" class="ion-social-twitter"></ion-icon></a></li>
                        <li><a href="#"><ion-icon name="logo-googleplus" class="ion-social-googleplus"></ion-icon></a></li>
